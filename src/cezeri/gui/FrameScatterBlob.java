...
public final class FrameScatterBlob extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        panel_blob = new cezeri.gui.PanelScatterBlob();
...
//                frm.getScatterPlotPanel().setAxisText(s);
    ...
    private void savePanel() {
        PanelScatterBlob cp = getScatterBlobPanel();
        ...
        if (file != null) {
            ImageProcess.saveGridImage(ImageProcess.getBufferedImage(getScatterBlobPanel()), file.getAbsolutePath());
        } else {
