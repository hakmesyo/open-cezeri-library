...
public class yolo {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        String modelWeights = "models/yolov3_tiny.weights"; //Download and load only wights for YOLO , this is obtained from official YOLO site//
